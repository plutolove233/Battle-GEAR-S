## test_pilot_088_morgk.gd - 莽克（pilot_088，混乱 N，cost 4, attack_limit 1, action_card_limit 3）效果测试
##
...
func _setup_pilot_088(battle, owner_id: StringName):
	...
	var card = _make_instance(gs, cdb, "pilot_088_莽克", owner_id)
	if card == null:
		return null
...
func test_pilot_088_effect_definitions() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var ids: Array = _ActionPilotEffects.get_effects_for_pilot(&"pilot_088_莽克", battle.context)
	var id_strs: Array = []
	for i in ids:
...
func test_pilot_088_self_equipment_discard_gives_4() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
	if s == null:
		return "setup 失败（缺 pilot_088_莽克）"
	var gs = s.gs
	var cdb = s.cdb
	var player = s.player
...
func test_pilot_088_other_equipment_discard_gives_3() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
...
func test_pilot_088_hand_equipment_discard_no_gold() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
...
func test_pilot_088_reserve_face_down_discard_no_gold() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
...
func test_pilot_088_replace_reason_also_counts() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
...
func test_pilot_088_multi_discard_accumulates() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
...
func test_pilot_088_sell_set_equipment_counts() -> Variant:
	var battle := _new_battle()
	if battle == null or battle.context == null:
		return "battle 初始化失败"
	var s = _setup_pilot_088(battle, &"player")
